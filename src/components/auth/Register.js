...
const Register = (props) => {
  ...
  const { verifyEmail, register, clearStatus, registration, status, isAuthenticated } = authContext
          ...
          <div className='justify-content-center' style={{display: 'flex', paddingTop: '16px'}}>
            ...
            <Box onSubmit={onSubmitEmail}
              ...
              <TextField key={8} id="outlined-basic email" type="text"
                ...
                InputProps={
                  {endAdornment: <Button id="timer" disabled={otpOpen.disabled} type="submit">{otpOpen.open ? <CircularProgress style={{height: '22px', width: '22px'}} /> : 'OTP'}</Button>}
                }
            ...
            <TextField id="outlined-basic otp" type="text"
              ...
              />
              <br />
            <Button style={{height: '50px', background: 'blue'}} type="submit" size="large" color="primary" variant="contained">Sign up</Button>
            </Box>
